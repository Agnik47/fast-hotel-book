...
const Navbar = () => {
  ...
  //!Cleark provide openSignin and user
  ...
  useEffect(() => {
    if (location.pathname === "/") {
      ...
      // Initial check in case the user reloads mid-scroll
      setIsScrolled(window.scrollY > 10);
  
      return () => window.removeEventListener("scroll", handleScroll);
    } else {
      // On other pages, always set as scrolled (true)
      setIsScrolled(true);
    }
  }, [location.pathname]);
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-4 lg:gap-8">
        ...
        {user && (
          ...
          onClick={()=>navigate('/owner')}
            className={`border px-4 py-1 text-sm font-light rounded-full cursor-pointer hover:bg-gray-800 hover:border-gray-800 hover:text-white ${
      ...
      <div className="hidden md:flex items-center gap-4">
        <img
          ...
          className={`${
            isScrolled && "invert"
          } h-7 transation-all decoration-500 cursor-pointer`}
        />
